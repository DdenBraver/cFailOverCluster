...
function Set-TargetResource
{
    ...
    try
    {
        ...
        else
        {
            ...
            $AddClusterParameters = @{Name = $env:COMPUTERNAME; Cluster=$Name;} 
            if ($Nostorage -eq $true)
            {
                $AddClusterParameters.Add('NoStorage',$true)
            }

            Add-ClusterNode @AddClusterParameters
